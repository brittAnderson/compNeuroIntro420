...
#+begin_src haskell :session :cache no :results silent :exports nil
...
*** Generate your own plot of the exponential function. :exercise:
    This can be done in class. It is not homework and is not graded. It is just something you can do to work on your skills. 
** Reprise
