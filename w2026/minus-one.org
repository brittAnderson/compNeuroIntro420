...
** What is a scientific theory?
   And how to the notions of prediction and explanation fit into this? Is the ability to predict the tides a theory of the tides? Is it an explanation of the tides?
...
** Do we have a theory crisis in Psychology [cite:@oberauer2019]?
   You might find these citations relevant for discussion [cite:@guest21_how_comput_model_can_force; @rooij21_theor_befor_test; @Borsboom_2021; @naur85_progr_as_theor_build; @Eronen_2020; @Koch_2025; @Oude_Maatman_2021].
