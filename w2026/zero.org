...
Meets: Thursday 11:30 - 14:20
Room: HH 2107

*** Buzzati and The Singularity

**** Comment                                                       :noexport:
   This chapter gives us a chance to break the ice and talk about some of the issues of whether mental life is just computation or something more. That may also lead to a question about what is computation and how much cognition depends on the specifics of our biology? Even issues of consciousness are introduced as part of the piece
   
**** Roll Call                                                     :noexport:
   - Who is everyone?
   - What is their background?
   - What is their computing skill set?

*** What will we study and how will we study it?

**** The high level issues
:PROPERTIES:
:CUSTOM_ID: zero-high-level-issue
:END:
...
#+begin_src R :session *rtest*  :exports code :results silent
myadd <- function(a,b) {a + b}
#+end_src

#+begin_src R :session *rtest* :exports both  :results output
  myadd(3,4)
#+end_src
