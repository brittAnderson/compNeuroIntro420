...
* Computational Neuroscience Day 2 IAMHERE
...
:     Could not find module ‘Sqrt’.
:     It is not a module in the current program, or in any known package.
: <interactive>:4:1-11: error: [GHC-88464]
:     Variable not in scope: getCubeRoot :: t0 -> t1 -> t2 -> t
: <interactive>:5:1-11: error: [GHC-88464]
:     Variable not in scope: getCubeRoot :: t0 -> t1 -> t2 -> t
: <interactive>:6:1-11: error: [GHC-88464]
:     Variable not in scope: getCubeRoot :: t0 -> t1 -> t2 -> t
...
#+begin_example
<no location info>: error: [GHC-35235]
    Could not find module ‘MyMats’.
    It is not a module in the current program, or in any known package.
a =
<interactive>:1133:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: t0 -> String

<interactive>:1133:20-23: error: [GHC-88464]
    Variable not in scope: mata
b =
<interactive>:1135:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: t0 -> String

<interactive>:1135:20-23: error: [GHC-88464]
    Variable not in scope: matb
a + b =
<interactive>:1137:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: a0 -> String

<interactive>:1137:22-33: error: [GHC-88464]
    Variable not in scope: add2SimpMats :: t0 -> t1 -> a0

<interactive>:1137:35-38: error: [GHC-88464]
    Variable not in scope: mata

<interactive>:1137:40-43: error: [GHC-88464]
    Variable not in scope: matb
#+end_example
...
#+begin_example
c =
<interactive>:1141:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: t0 -> String

<interactive>:1141:20-23: error: [GHC-88464]
    Variable not in scope: matc
d =
<interactive>:1143:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: t0 -> String

<interactive>:1143:20-23: error: [GHC-88464]
    Variable not in scope: matd
c * d =
<interactive>:1145:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: a0 -> String

<interactive>:1145:22-33: error: [GHC-88464]
    Variable not in scope: multSimpMats :: t0 -> t1 -> a0

<interactive>:1145:35-38: error: [GHC-88464]
    Variable not in scope: matc

<interactive>:1145:40-43: error: [GHC-88464]
    Variable not in scope: matd
#+end_example
Classroom Exercise
#+begin_quote
...
#+RESULTS:
: <interactive>:1148:1-10: error: [GHC-88464]
...
#+RESULTS:
#+begin_example
<interactive>:1152:31-38: error: [GHC-88464]
    Variable not in scope: testData :: [a0]

<interactive>:1154:16-23: error: [GHC-88464]
    Variable not in scope: oneRound :: t0 -> t1 -> [a]

<interactive>:1154:25-27: error: [GHC-88464]
    Variable not in scope: myw

<interactive>:1154:29-38: error: [GHC-88464]
    Variable not in scope: testDataFs
<interactive>:1155:1-7: error: [GHC-88464]
    Variable not in scope: checkWt :: t0 -> t1 -> t

<interactive>:1155:9-13: error: [GHC-88464]
    Variable not in scope: newwt

<interactive>:1155:15-22: error: [GHC-88464]
    Variable not in scope: testData

<interactive>:1157:17-24: error: [GHC-88464]
    Variable not in scope: oneRound :: t0 -> t1 -> [a]

<interactive>:1157:26-30: error: [GHC-88464]
    Variable not in scope: newwt

<interactive>:1157:32-41: error: [GHC-88464]
    Variable not in scope: testDataFs
<interactive>:1158:1-7: error: [GHC-88464]
    Variable not in scope: checkWt :: t0 -> t1 -> t

<interactive>:1158:9-14: error: [GHC-88464]
    Variable not in scope: newwt2

<interactive>:1158:16-23: error: [GHC-88464]
    Variable not in scope: testData
#+end_example
...
#+RESULTS:
#+begin_example
<interactive>:1161:23-29: error: [GHC-76037]
    Not in scope: type constructor or class ‘SimpMat’
<interactive>:1162:23-29: error: [GHC-76037]
    Not in scope: type constructor or class ‘SimpMat’
<interactive>:1163:12-23: error: [GHC-88464]
    Variable not in scope: multSimpMats :: t3 -> a0 -> b

<interactive>:1163:26-39: error: [GHC-88464]
    Variable not in scope: binary2Bipolar :: t2 -> t3

<interactive>:1163:42-52: error: [GHC-88464]
    Variable not in scope: rotateLList :: t1 -> t2

<interactive>:1163:54-57: error: [GHC-88464]
    Variable not in scope: hopa

<interactive>:1163:63-76: error: [GHC-88464]
    Variable not in scope: binary2Bipolar :: t0 -> a0

<interactive>:1163:78-81: error: [GHC-88464]
    Variable not in scope: hopa
<interactive>:1164:12-23: error: [GHC-88464]
    Variable not in scope: multSimpMats :: t3 -> a0 -> b

<interactive>:1164:26-39: error: [GHC-88464]
    Variable not in scope: binary2Bipolar :: t2 -> t3

<interactive>:1164:42-52: error: [GHC-88464]
    Variable not in scope: rotateLList :: t1 -> t2

<interactive>:1164:54-57: error: [GHC-88464]
    Variable not in scope: hopb

<interactive>:1164:63-76: error: [GHC-88464]
    Variable not in scope: binary2Bipolar :: t0 -> a0

<interactive>:1164:78-81: error: [GHC-88464]
    Variable not in scope: hopb
<interactive>:1165:15-26: error: [GHC-88464]
    Variable not in scope: add2SimpMats :: t0 -> t1 -> t

<interactive>:1165:28-35: error: [GHC-88464]
    Variable not in scope: outProda

<interactive>:1165:37-44: error: [GHC-88464]
    Variable not in scope: outProdb
<interactive>:1166:22-33: error: [GHC-88464]
    Variable not in scope: zeroDiagonal :: t0 -> t

<interactive>:1166:35-45: error: [GHC-88464]
    Variable not in scope: outProdBoth
<interactive>:1167:13-26: error: [GHC-88464]
    Variable not in scope: scalarMultiply :: t0 -> t1 -> t

<interactive>:1167:30-46: error: [GHC-88464]
    Variable not in scope: noSelfConnections
<interactive>:1168:10-18: error: [GHC-88464]
    Variable not in scope: prettyMat :: t0 -> String

<interactive>:1168:20-28: error: [GHC-88464]
...
#+begin_src R :exports none :session *rfca*  :results silent
...
#+BEGIN_SRC R :exports results :session *rfca* :results graphics file :file ../images/lvll.png
