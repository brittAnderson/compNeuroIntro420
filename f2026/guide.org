...
*** Git Clone and Github Acct :assignment:
    An early home work will be a screen shot of your github homepage showing you forked or cloned the course repository. And the screen shot should be done using a program and not your phone. [[https://github.com/brittAnderson/compNeuroIntro420][Course Webpage]] . That is the course content. If you want to view a web viewable form you can go to this link: [[https://brittanderson.github.io/compNeuroIntro420/][coursge notes]].
...
** Probably concludes the day.

Emphasize to bring something to right with and paper to write on that you will give me.
