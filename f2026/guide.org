...
** What are examples of working combining cognitive, computational, and neuroscience methods?
...
#+begin_src haskell :dir . :session :cache yes :results file graphics :file ../images/expdecay.png :exports both
...
#+begin_src haskell :dir . :session :results file graphics :file ../images/derivExample.png :exports both :cache yes
...
Now let's test it:
#+begin_src haskell :cache yes :results output :exports both
  :load "../src/Sqrt.hs"
  import Sqrt
...
#+begin_src haskell :dir . :session :results file graphics :file ../images/spring.png :exports both :cache yes
  import Spring
  :load "../src/Spring.hs"
...
#+begin_src haskell :dir . :session :results file graphics :file ../images/iandf.png :exports both :cache yes
  import IandF
    :load ../src/IandF.hs
...
#+begin_src haskell :dir . :session :results file graphics :file ../images/handh.png :exports both :cache yes
  import HandH
...
#+begin_src haskell :dir . :session :output :exports both :cache yes
import BusyBeaver
...
#+BEGIN_SRC haskell :session *lambdademo* :exports both :results output :cache yes
  :set -w
...
#+begin_src haskell :session :results file graphics :file ../images/rule30.png :exports  both :cache yes
  import Automata
...
#+begin_src haskell :dir . :session :exports both :results output :cache yes
  :load "../src/MyMats.hs"
  import MyMats                                                                   
  putStrLn $ "a = "
...
- The "AND" Operation/Function ::
  ...
  #+begin_src gnuplot :var data="and.txt" :file ../images/my-and.png :cache yes
    reset
    set nokey
    set nocolorbox
...
- The "OR" Operation/Function ::
  ...
  #+begin_src gnuplot :var data="or.txt" :file ../images/my-or.png :cache yes
    reset
    set nokey
    set nocolorbox
    set palette model RGB defined ( 0 "red", 1 "green" )
...
- The "XOR" Operation/Function ::
  ...
  #+begin_src gnuplot :var data="xor.txt" :file ../images/my-xor.png :cache yes
    reset
    set nokey
    set nocolorbox
    set palette model RGB defined ( 0 "red", 1 "green" )
...
#+begin_src haskell :dir . :session :results output :exports both :cache yes
...
#+begin_src R :exports none :session *rfca*  :results silent :cache yes
...
#+BEGIN_SRC R :exports results :results output :session *rfca* :cache yes
...
#+BEGIN_SRC R :exports results :session *rfca* :results graphics file :file ../images/lvll.png :cache yes
