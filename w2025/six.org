...
#+begin_src python :results silent :exports none :session *dags*
import networkx as nx
from matplotlib import pyplot as plt
}
#+end_src

#+begin_src python :results graphics file output :file Basic.png :exports results :session *dags*
Basic = nx.DiGraph()
...
#+begin_src python :results graphics file output :file Disease.png :exports results :session *dags*
Disease = nx.DiGraph()
