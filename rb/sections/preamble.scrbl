...
Of course one cannot explore computationally mathematical ideas without having some familarity computing basics: writing code,  markup syntaxes for reports and documentation, and ancillary tools such as @emph{git} for sharing. In years past, I combined all these content areas into this single course. The heterogeneity of student backgrounds made that tough, but as there were no alternatives it was necessary. Now however, I have split off the computing tools part from this content part. Students can and should come to this course with some basic familiarity with using their computer as a research tool. If they do not have that knowledge they can gain it from a variety of on-line sources. I outline my approach @hyperlink["https://github.com/brittAnderson/Intro2Computing4Psychology/blob/s22/startHere/outline.org"]{here}, and I have developed various @hyperlink["https://vimeo.com/channels/i2c4p"]{videos} to support using that online material.

@(youtube "https://player.vimeo.com/video/448900968?h=eff8e7355a&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" )


Freeing this course from the constraints of teaching computing basics provides the space for including new content and teaching the older material differently. I would like both novice programmers and those with more experience programming to be able to get something from the exercises. I have explicitly decided not to use a  more common programming languages, such as python, so that everyone can focus on what it is we are trying to do, and not just what library can we import or what code we can find online to cut and paste. With the freedom to select any computing language I had the chance to harken back to the early days of artificial intelligence (AI); an era when AI was about thinking and reasoning and not how to import a model pretrained on billions of examples. By choosing a LISP I can also engage in a discussion of how programming languages differ, and how the design choices and features of a programming language may influence the expression of our theoretical ideas. Can a particular programming language lead us to new ways of thinking and conceiving of the problem space we wish to explore theoretically and via simulation?

All that is grand, but the course is still intended for undergraduates, many of whom may only possess programming rudiments. How to get them all, the Mac Users (both Intel and M1/2) as well as Windows and *Nix users to have a common environment so that I can teach the same thing to all and that they can get installed on their computers in less than a month. Common-Lisp (CL) would be ideal, and I wrote some of the code for an @hyperlink["https://github.com/brittAnderson/compNeuroIntro420/tree/lisp"]{earlier offering} in CL, but installing CL and getting a sane working environment can be challenging. Thus, I decided to try @hyperlink["https://racket-lang.org/"]{Racket}. It is a language designed to support teaching, and has the DrRacket IDE. This works pretty much out of the box on Linux, Windows, and OSX systems. It even has a documentation system, scribble, built-in, and which I am using to write this document. 

The remaining question is what new content to include. So far, I plan to expand the section on neuron modeling with an additional example, the Morris-Lecar model that gives us a chance to how the differential equation formulation gives us additional chances for model exploration by looking at the phase space.

I also can now include something more traditional in the history of computational models of mind by letting us code up a simple Turing machine so that we have some familiarity with this oft cited entity. How much more space is left of additional models, I would like to get the Kohonen neural network a week too, will have to be seen from this first go around. 
