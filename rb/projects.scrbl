...
Genetic algorithms are algorithms were the "learning" takes place via selection and recombination in analogy to evolution. It has been used to select the parameters of otherwise conventional neural networks, but can also be used on its own. If you select this project you will need to explain what a genetic algorithm is, make the case that it is relevant to some aspect of neural or psychological modeling, and provide some racket code implementing some examples. A @hyperlink["https://www.whitman.edu/Documents/Academics/Mathematics/2014/carrjk.pdf"]{tutorial paper (pdf)} with MATLAB® code is available. A more academic treatment (and much deeper treatment) is available as a review @~cite[neuroevo]. A recent podcast features a discussion with one of the authors, @hyperlink["https://thegradientpub.substack.com/p/joel-lehman-open-endedness-and-evolution#details"]{Joel Lehman}.
...
This is a @hyperlink["https://en.wikipedia.org/wiki/FitzHugh%E2%80%93Nagumo_model"]{model} of neuronal firing that is very commonly used as a simpler, but informative, example of neuronal dyanmics. For this project you will implement this model and demonstrate how to visualize the effects of parameter manipulations, e.g. by using @hyperlink["https://docs.racket-lang.org/plot/renderer2d.html#%28def._%28%28lib._plot%2Fmain..rkt%29._vector-field%29%29"]{vector field} plots. 
